    ...
    <form method="post" action="">
        <table>
            ...
            <tr>
                <td>abs</td>
                <td>
                    <input type="radio" name="abs" value="1" <?= ($wiersz['abs'] ?? '') == 'tak' ? 'checked' : '' ?>>Tak
                    <input type="radio" name="abs" value="0" <?= ($wiersz['abs'] ?? '') != 'tak' ? 'checked' : '' ?>>Nie
                </td>
            </tr>
            <tr>
                <td>esp</td>
                <td>
                    <input type="radio" name="esp" value="1" <?= ($wiersz['esp'] ?? '') == 'tak' ? 'checked' : '' ?>>Tak
                    <input type="radio" name="esp" value="0" <?= ($wiersz['esp'] ?? '') != 'tak' ? 'checked' : '' ?>>Nie
                </td>
            </tr>
            <tr>
